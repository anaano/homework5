...
public class CustomerService {
    ...
    private final CityService addressService;

    @Autowired
    public CustomerService(CustomerRepository customerRepository, CityService addressService) {
    ...
    public Customer addEditCustomer(AddCustomer addCustomer, Long id) throws Exception {
        ...
        City address = addressService.getAddress(addCustomer.getAddress());
